...
In an object-oriented world, ECS components contain the data of a "mixin" or (in case of multiple inheritance) a single superclass, whereas a system contains the mixin's oe superclass's implementation.
